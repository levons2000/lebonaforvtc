...
public class AdapterForPosts extends RecyclerView.Adapter<AdapterForPosts.ViewH>{
    ...
    public void onBindViewHolder(@NonNull final ViewH holder, int position) {
        ...
        Picasso.with(context).load(model.getImgUrl()).into(holder.imageView);
    }
    ...
    class ViewH extends RecyclerView.ViewHolder{
        ...
        public ViewH(View v) {
            super(v);
            imageView = (ImageView) v.findViewById(R.id.imageforitem);
            likeButton = (ImageButton) v.findViewById(R.id.likebutton);
            commentButton = (ImageButton) v.findViewById(R.id.commentbutton);
            shareButton = (Button) v.findViewById(R.id.sharebutton);
            likeCounterText = (TextView) v.findViewById(R.id.likecountertext);
            commentCounterText = (TextView) v.findViewById(R.id.commentcountertext);
